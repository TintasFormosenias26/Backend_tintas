...
export type GetPreferenceGroupByPayload<T extends PreferenceGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type PreferenceWhereInput = {
  ...
  categories?: Prisma.StringNullableListFilter<"Preference">
  formats?: Prisma.StringNullableListFilter<"Preference">
...
export type PreferenceCreateInput = {
  id?: string
  categories?: Prisma.PreferenceCreatecategoriesInput | string[]
  formats?: Prisma.PreferenceCreateformatsInput | string[]
...
export type PreferenceUpdateInput = {
  ...
  categories?: Prisma.PreferenceUpdatecategoriesInput | string[]
  formats?: Prisma.PreferenceUpdateformatsInput | string[]
...
export type PreferenceCreatecategoriesInput = {
  set: string[]
}

export type PreferenceCreateformatsInput = {
  set: string[]
}

export type PreferenceUpdatecategoriesInput = {
  set?: string[]
  push?: string | string[]
}

export type PreferenceUpdateformatsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type PreferenceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "categories" | "formats", ExtArgs["result"]["preference"]>
...
export interface PreferenceFieldRefs {
  ...
  readonly categories: Prisma.FieldRef<"Preference", 'String[]'>
  readonly formats: Prisma.FieldRef<"Preference", 'String[]'>
}
